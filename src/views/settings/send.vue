...
import { ref } from 'vue'
let dvaluebefore= localStorage.getItem('downloadpath') || 'C://download'
const dvalue = ref(dvaluebefore)
const handleInput = (v:string) => {
 localStorage.setItem('downloadpath',v) 
 dvalue.value = localStorage.getItem('downloadpath') || 'C://download'
}
...
<template>
    <div class="wd">
        ...
        <div class="content">
            ...
            <div class="desc">
                <n-input  @input="handleInput" v-model:value="dvalue" type="text" placeholder="基本的 Input" />
        ...
        <div class="content">
         ...
         开启自动备份
            ...
            <div class="desc">
                <n-checkbox size="medium" label="开启自动备份" />
            ...
            <div class="desc">
                <n-input v-model:value="dvalue" type="text" placeholder="基本的 Input" />
